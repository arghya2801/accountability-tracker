...
export default function Home() {
  return (
    <>
      <Navbar />
      <div className="flex flex-col md:flex-row gap-0 mb-6 width-full py-4">
        <div className="flex-1 min-w-[50%]">
          <div className="font-bold mb-2 m-4">{`${USER_A.name}'s goals`}</div>
          <GoalsTable userId={USER_A.id}/>
        </div>
        <div className="flex-1 min-w-[50%]">
          <div className="font-bold mb-2 m-4">{`${USER_B.name}'s goals`}</div>
